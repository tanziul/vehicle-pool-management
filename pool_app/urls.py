...
urlpatterns = [
    ...
    path('admin/add-driver/', views.add_driver, name='add_driver'),           # FIXED
    path('admin/edit-driver/<int:pk>/', views.edit_driver, name='edit_driver'), # FIXED
    path('admin/delete-driver/<int:pk>/', views.delete_driver, name='delete_driver'), # FIXED
